<div class="modal fade chart-of-account-modal-template" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                {!! Form::open(['url' => '#', 'method' => 'POST']) !!}
                    ...
                    @include('components.form.general.text-w-label', [
                        'name' => 'chart_of_account_description',
                        'label' => 'Description',
                        'form_class' => 'description'
                    ])

                    @include('components.form.general.select2-w-label-uninitialized', [
                        'array' => config('kusimi.chart-of-account-classifications'),
                        'name' => 'chart_of_account_classification',
                    ...
                    @include('components.form.general.select2-w-label-uninitialized', [
                        'array' => config('kusimi.chart-of-account-types'),
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3 delete-section d-none">
                            <a href="{{ route('chart-of-account.destroy', 'ID') }}" data-confirm="Confirm delete this record?"
