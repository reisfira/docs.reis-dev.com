...
{!! Form::model($resource, ['url' => route('file-maintenance.payment-method.update', $resource->id), 'method' => 'PUT' ]) !!}
    <div class="form-group row">
        <div class="col-8"></div>
        <div class="col-2">
            @include('components.form.general.delete-master', [
                'route' => route('file-maintenance.payment-method.destroy', $resource->id),
                'confirmation_prompt' => "Confirm delete this payment method {$resource->details}?",
                'deletable' => true,
            ])
        </div>
        <div class="col-2">
...
@include('components.form.others.open-create-page', [
    ...
    'route' => route('file-maintenance.payment-method.create')
])
@endsection
