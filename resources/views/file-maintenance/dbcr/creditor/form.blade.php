    ...
    <div class="card-body">
        <div class="row">
            <div class="col-6">
                ...
                @include('components.form.general.text-w-label-lookup', [ 'name' => 'account_code', 'label' => 'Acc. Code', 'narrow_gutter' => true, 'is_required' => true ])
                ...
                @include('components.form.general.text-w-label', [ 'name' => 'memo', 'label' => 'Memo/Remark', 'narrow_gutter' => true ])

                <div class="mt-3"></div>
                <strong class="font-weight-bold small clearfix">OPTIONS</strong>
                @include('components.form.general.checkbox', [ 'name' => 'is_trade_account', 'label' => 'Trade Creditor', 'checked' => isset($resource) ? $resource->is_trade_account : false ])
            ...
            <div class="col-6">
                ...
                @include('components.form.general.text-w-label', [ 'name' => 'gst_code', 'label' => 'GST Code', 'narrow_gutter' => true ])
