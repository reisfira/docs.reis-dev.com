...
<div class="form-group row {{ $row_gutter }}">
    {!! Form::label('account_code', $label ?? 'Account Code.', ['class' => "col-sm-3 col-form-label {$font_weight} {$required}"]) !!}
    <div class="col-sm-8">
        <div class="input-group">
            ...
            {{-- ! actual account_code input --}}
            @include('components.form.special.account-code-input', [ 'narrow_gutter' => false ])
