...
class Creditor extends Model
{
    ...
    protected $appends = [ 'details', 'gst_vdate_dmy' ];
    ...
    /** static function */
    public static function findByAccountCode($account_code, $column = 'full_code') { return Creditor::where($column, $account_code)->first(); }
