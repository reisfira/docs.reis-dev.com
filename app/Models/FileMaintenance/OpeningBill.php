...
class OpeningBill extends Model
{
    use SoftDeletes;

    protected $table = 'acc_opening';
    protected $fillable = [
        'doc_no',
        'account_code',
        'is_debtor',
    ...
    protected $appends = [ 'code', 'date_dmy' ];
    ...
    {
        $next = OpeningBill::withTrashed()->where('account_code', $account_code)->count() + 1;
        $prefix = "OB/{$account_code}";
