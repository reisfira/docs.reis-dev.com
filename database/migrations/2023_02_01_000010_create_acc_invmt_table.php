...
class CreateAccInvmtTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acc_invmt', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('reference')->nullable()->comment('if invoice posted from stocks have reference like sales order no. it goes here');
