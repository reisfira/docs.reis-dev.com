...
class CreateAccCndtTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acc_cndt', function (Blueprint $table) {
            ...
            $table->string('reference_no')->index()->nullable()->comment('used for the entry form table, it should be used to auto select the offset_bill_no');
            $table->string('offset_bill_no')->index()->nullable()->comment('used for offset - similar functionality at RV');
